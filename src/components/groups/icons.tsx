...
export function Plus(props: ComponentProps<'svg'>) {
    return (
        ...
        >
            <path
                fill='green'
                d='M8 1c.553 0 1 .447 1 1v5h5c.553 0 1 .447 1 1s-.447 1-1 1h-5v5c0 .553-.447 1-1 1s-1-.447-1-1v-5H2c-.553 0-1-.447-1-1s.447-1 1-1h5V2c0-.553.447-1 1-1z'
            />
        </svg>
...
export function Eye(props: ComponentProps<'svg'>) {
    return (
        ...
        >
            ...
            <path
                fill='green'
                d='M12 4.5c-7.53 0-11.73 7.19-11.97 7.68-.09.17-.09.38 0 .55.24.49 4.44 7.68 11.97 7.68 7.53 0 11.73-7.19 11.97-7.68.09-.17.09-.38 0-.55C23.73 11.69 19.53 4.5 12 4.5zm0 13c-4.25 0-7.43-4.11-8.77-6 1.34-1.89 4.52-6 8.77-6 4.25 0 7.43 4.11 8.77 6-1.34 1.89-4.52 6-8.77 6zm0-9.5c-1.93 0-3.5 1.57-3.5 3.5s1.57 3.5 3.5 3.5 3.5-1.57 3.5-3.5-1.57-3.5-3.5-3.5zm0 5c-.83 0-1.5-.67-1.5-1.5S11.17 10 12 10s1.5.67 1.5 1.5S12.83 13 12 13z'
            />
        </svg>
...
export function Search(props: ComponentProps<'svg'>) {
    return (
        ...
        >
            <path
                fill='green'
                d='M15.5 14h-.79l-.28-.27a6.471 6.471 0 0 0 1.48-5.34C14.84 5.59 12.42 3.5 9.5 3.5S4.16 5.59 3.09 8.39c-1.25 3.65.57 7.71 4.22 8.95a6.471 6.471 0 0 0 5.34-1.48l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z'
            />
        </svg>
